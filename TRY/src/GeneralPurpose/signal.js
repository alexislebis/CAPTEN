// === SIGNALS
  // === SIGNALS ID
    ...
    // === STEP
      ...
      var STEP_OPERATION_PARAMETER_TO_WORK_WITH_SIGNAL_ID = "-8e60v0ds3SC4vcovfefe8e4vz8ev4dDVEVD";
      var STEP_USE_FOLLOWING_RGTE_SIGNAL_ID = "-OZHbbnlrbNLPE:rb566ez5evd";
    ...
    // === RGTE
      ...
      var GRAPH_ELEMENT_AS_VOCABULARY_SELECTED_SIGNAL_ID = "-848E46zg48ez64g6zeazOOLE?Borb,er";
    ...
    // === TOKENS
      ...
      // === DIMENSION DISPLAYER
        var DIMENSION_DISPLAYER_REQUIRE_UPDATE_SIGNAL_ID = "-IHZENJ4QKELe8er78r77LKEUE";
